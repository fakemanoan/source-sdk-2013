...
#define	TF_WEAPON_SNIPERRIFLE_DAMAGE_MIN		25
#define TF_WEAPON_SNIPERRIFLE_DAMAGE_MAX		100
#define TF_WEAPON_SNIPERRIFLE_RELOAD_TIME		3f
#define TF_WEAPON_SNIPERRIFLE_ZOOM_TIME			0.5f

#define TF_WEAPON_SNIPERRIFLE_NO_CRIT_AFTER_ZOOM_TIME	0.4f
